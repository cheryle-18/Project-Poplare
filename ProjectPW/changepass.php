    ...
    <div class="content ps-5 pe-5 pt-5 pb-5">
        ...
        <div class="right p-2">
            <div class="title card p-2 ps-4 mb-3" style="background-color: #f5f3f0;">
                <h1><b>Change My Password</b></h1>
            </div>
            <div class="passInfo card p-4 mb-3" style="background-color: #f5f3f0;">
                <form action="usercontrol.php" method="POST">
                    <div class="mb-3">
                    ...
                    <div class="buttons d-flex">
                        ...
                        <button class="hoverable btn mt-2 ms-1" name="changePass">Save</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        $("document").ready(function(){
            $("#confirm").blur(function(){
                ...
                $.post("usercontrol.php", {conf: paramConf, pass: paramPass}, function(data, status){
                    if(data!=""){
