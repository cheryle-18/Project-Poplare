...
<div class="container-fluid navku">
    ...
    <div class="content ps-5 pe-5 pt-5 pb-5" style="margin-top:62px;">
        ...
        <div class="right p-2">
            ...
            <div class="shippingInfo card p-4 mb-3" style="background-color: #f5f3f0;">
                <form action="usercontrol.php" method="POST">
                    <div class="mb-3">
                        <label class="form-label">Address</label>
                        <input type="text" name="address" class="form-control" id="address" value='<?= $userShip["address"] ?>'>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">City</label>
                        <input type="text" name="city" class="form-control" id="city" value='<?= $userShip["city"] ?>'>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">State / Province</label>
                        <input type="text" name="province" class="form-control" id="province" value='<?= $userShip["province"] ?>'>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Postal Code</label>
                        <input type="text" name="postcode" class="form-control" id="postcode" value='<?= $userShip["postcode"] ?>'>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Phone Number</label>
                        <input type="text" name="phone" class="form-control" id="phone" value='<?= $userShip["phone"] ?>'>
                    </div>
                    <div class="buttons d-flex">
                        <button class="hoverable btn mt-2" name="back">Back</button>
                        <button class="hoverable btn mt-2 ms-1" name="saveShipping" value='<?= $userShip["id_shipping"] ?>'>Save</button>
                    </div>
                </form>
            </div>
        </div>
