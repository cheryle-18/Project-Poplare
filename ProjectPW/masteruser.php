...
<nav class="navbar navbar-expand-xxl navbar-dark ps-xl-5 pe-xl-5" style="background-color: #013221;">
    ...
    <div class="content p-5">
        <div class="row mx-0">
        <h4 style="padding:0px;">Show only :</h4>
        <select class="form-select w-25 mb-4" aria-label="Default select example" id="idselect">
            <option selected>All</option>
            <option value="1">Pending Member</option>
            <option value="2">Member</option>
            <option value="3">Non Member</option>
        </select>
        <div class="col-12 px-0 mt-5" id="pending">
                            ...
                            foreach($users as $key => $value){
                                ...
                                <tr>
                                    ...
                                    <form action="admincontrol.php" method="POST">
                                        <button name="btnConfMember" value='<?= $value["id_user"] ?>' class="btn btn-dark" style="background-color: #013221;">Confirm</button>
                                    </form>
                                    <form action="userdetail.php" method="POST">
                                        <button class="btn btn-outline-dark  btn-detail ms-1" style="background-color: #013221; color: white;" value='<?= $value["id_user"] ?>' name="btnDetUser">Detail</button>
                                    </form>
                                    </td>
                                </tr>
                            <?php
        ...
        <div class="col-12 px-0 mt-5" id="member">
                        ...
                        <?php
                            foreach($users as $key => $value){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="userdetail.php" method="POST">
                                            <button class="btn btn-outline-dark  btn-detail"style="background-color: #013221; color: white;" value='<?= $value["id_user"] ?>' name="btnDetUser">Detail</button>
                                        </form>
                                    </td>
                                </tr>
                            <?php
            ...
            <div class="col-12 px-0 mt-5" id="non">
