<?php
    ...
    if(isset($_POST["orderDetail"])){
        $_SESSION["idHtrans"] = $_POST["orderDetail"];
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            ?>
                    ...
                    var txt = `<div class="alert alert-success text-center" role="alert" id="txt" style="position:fixed;top:0px;left:0px;width:100%;display:none;background-color:green; color:white;font-size:1.3em;">`+message+`</div>`;
...
<div class="container-fluid navku">
    ...
    <div class="content ps-5 pe-5 pt-5 pb-5 d-flex" id="content" style="margin-top: 62px;">
        <div id="overlay2">
        ...
        <div class="right p-2">
            ...
            <?php
                ...
                if($jmlh>0){
                    ?>
                    <div class="orderCards p-4 d-flex flex-wrap w-100 rounded" style="background-color: #f5f3f0;">
                        <?php
                            foreach($orders as $key => $value){
                                ?>
                                <div class="orderCard p-4 m-2" style="background-color: #f5f3f0; border: 1px solid #013221;">
                                    Order ID : #<?= $value["id_htrans"] ?> <br>
                                    Status : <?= $value["status"] ?><br>
                                    Order Date : <?= date("d/m/Y", strtotime($value["trans_date"])) ?><br>
                                    Total Price : Rp <?= number_format($value["total"],0,'.','.') ?><br>
                                    Total Qty : <?= $value["qty"] ?> products<br>
                                    <form action="#" method="POST">
                                        <button class="btn hoverable w-100 mt-3" name="orderDetail" value="<?= $value["id_htrans"] ?>">View Details</button>
                                    </form>
                                </div>
                            <?php
                            }
                ...
                <?php
                    ...
                    ?>
                    <div class="card p-4 w-100" style="background-color: #f5f3f0; margin-bottom: 2vh;">
                        <h5>You haven't made any orders.</h5>
                        <form action="products.php" method="POST">
                            <button class="btn hoverable w-35 mt-2" name="cont">Continue Shopping</button>
                        </form>
                    </div>
                <?php
                }
            ?>
            <div class="p-3 ps-4 mb-3 mt-3 d-flex rounded" style="background-color: #f5f3f0;">
                <h5 class="mt-2 me-3">Have any problems?</h5>
                <button class="contact btn hoverable w-20" name="contactus" onclick="on()">Contact Us</button>
            </div>
        </div>
    </div>
