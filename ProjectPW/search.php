<?php
    ...
    $queryStr = "SELECT * FROM items WHERE Title like '$to_find'";
...
<body>
    ...
    <div class="content p-5 mx-auto w-100" style="justify-content: center;margin-top:60px">
        <?php
            if(count($items) == 0){
                ?>
                <h1 class="text-center p-2 text-white w-50 mx-auto infoku" style="background-color: #013221;border-radius:15px;">No Results</h1>
            <?php
            }
            else{
                ?>
            ...
            <div id="sortForm" class="d-sm-flex justify-content-center w-100">
                ...
                <div class="cards d-flex flex-wrap mt-4" id="tempKartu">
                    <?php
                            ...
                            <div class="card shadow mycard">
                                ...
                                <div class="card-body" style="margin-top: -20px;">
                                    ...
                                    <div class="buttons d-flex">
                                        ...
                                        <button class="hoverable btn mt-2 ms-1" name="btnAddCart" value='<?= $items[$i]["ID"] ?>'onclick="updt(<?=$items[$i]['ID']?>)">Add to Cart</button>
                                    </div>
                                </div>
                            </div>
                        <?php
